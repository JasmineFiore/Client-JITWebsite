...
export default function MbaIb({ title }) {
  ...
  return (
    <div>
      ...
      {/* 🔸 Info Section - Improved Version */}
      <section className="bg-linear-to-r from-white to-gray-50 py-12 px-6 md:px-12 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-start justify-between gap-12">
          {/* Left Text */}
          <div className="md:w-1/2 text-gray-700 space-y-6">
            <h2 className="text-xl md:text-2xl font-bold text-[#0A2342] border-l-4 border-[#0A2342] pl-3 leading-snug">
      ...
      {/* 🔹 Courses Section - Consistent Layout */}
      <section className="bg-linear-to-r from-white to-gray-50 py-6 px-6 md:px-12 flex justify-center text-gray-800">
        <div className="max-w-7xl w-full">
          {/* ===== CORE COURSES ===== */}
          <div id="core-courses" className="mb-16">
          ...
          {/* ===== ELECTIVE COURSES ===== */}
          <div id="elective-courses" className="mb-16">
            <h2 className="text-3xl font-bold text-[#0A2342] mb-6 uppercase">
              Elective Courses
            </h2>
            ...
            <div className="grid lg:grid-cols-3 gap-10">
              ...
              <div className="relative">
                ...
                <h3 className="font-semibold text-lg text-[#0A2342] mt-6 md:mt-20 mb-2">
                  Operations
                </h3>
                <ul className="space-y-2">
                  {[
                ...
                <img
                  ...
                  alt="Student"
                  className="hidden lg:block absolute -bottom-24 -right-10 w-44 h-72 rounded-lg"
                />
              </div>
            </div>
          </div>
      ...
      <div className=" px-6 md:px-10 text-gray-800 flex flex-col items-center">
      ...
      <section
        ...
        className="relative overflow-hidden bg-linear-to-r from-white to-gray-50 py-18 px-4 md:px-8 flex flex-col items-center"
      >
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-start justify-between gap-12">
          {/* ✅ Left: Text Content */}

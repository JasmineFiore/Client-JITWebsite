...
export default function CollegeOPharm() {
  ...
  const slides = [
    "/images/pharmacy/ph1.jpg",
    "/images/pharmacy/ph2.jpg",
    "/images/pharmacy/ph3.jpeg",
    "/images/pharmacy/ph4.jpeg",
    "/images/pharmacy/ph5.jpg",
  ];
  ...
  return (
    <div>
      {/* 🔹 Hero Section */}
      <section className="bg-[#0A2342] flex items-center justify-center px-10 py-3">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="text-white md:w-1/2">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              The College of Pharmacy offers Degree in Pharm.D, M.Pharm, B.Pharm
              and D.Pharm. JIT faculties are brilliant, highly qualified and
      ...
      <section className="bg-[#0A2342] py-20 px-10 text-center">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          >
            <img
              src="/images/pharmacy/courses/ph01.jpg"
              alt="B.Pharma"
          ...
          >
            <img
              src="/images/pharmacy/courses/ph02.jpg"
          ...
          >
            <img
              src="/images/pharmacy/courses/ph3.jpg"
          ...
          >
            <img
              src="/images/pharmacy/courses/ph4.jpg"
          ...
          >
            <img
              src="/images/pharmacy/courses/ph5.jpg"
          ...
          >
            <img
              src="/images/pharmacy/courses/ph6.jpg"
              alt="Computer Science Engineering"
              className="w-full h-40 object-cover group-hover:scale-105 transition-transform duration-300"
            />
            <div className="p-4">

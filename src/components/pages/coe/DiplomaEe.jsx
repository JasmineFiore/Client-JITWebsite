        ...
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          <div className="md:w-1/2 text-gray-700 space-y-6">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              ...
              and electromagnetism. The field first became an identifiable
              ...
              systems, signal processing and telecommunications.There are
              equally good opportunities for jobs in electrical engineering
              industry and higher education. There is lot of multidisciplinary
              research for developing electric vehicles with great funding and
              scope all over there world. On the same time good opportunities
              back home in industry.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-2xl shadow-lg p-8 hover:scale-[1.03] transition-transform duration-300">
            ...
            <p className="text-sm leading-relaxed text-gray-100">
              A diploma in electrical engineering can lead to a variety of
              career opportunities in fields such as power generation and
              distribution, telecommunications, electronics, and automation.
              Graduates may work as electrical or electronics technicians, field
              service engineers, quality control inspectors, or control systems
              technicians. They may also find employment in industries such as
              manufacturing, construction, transportation, or government. With
              additional education and experience, diploma holders may advance
              to roles such as project managers, design engineers, or electrical
              engineers.
            </p>
          </div>
          ...
          <div className="bg-white text-gray-800 rounded-2xl shadow-lg p-8 hover:scale-[1.03] transition-transform duration-300">
            ...
            <p className="text-sm leading-relaxed text-gray-700">
              Eligibility for a diploma in electrical engineering A candidate
          ...
          <div className="bg-yellow-400 text-gray-900 rounded-2xl shadow-lg p-8 hover:scale-[1.03] transition-transform duration-300">
            ...
            <p className="text-lg text-center text-gray-600 mb-6">
              Applicants will have to go through the following proce On the

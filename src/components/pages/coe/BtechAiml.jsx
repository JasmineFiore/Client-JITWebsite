        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white text-gray-800 rounded-lg shadow-lg p-8 transition-all hover:scale-[1.02]">
            ...
            <p className="text-sm leading-relaxed">
              Welcome to the curriculum of B.Tech in Computer Science and
              Engineering with specialization in Artificial Intelligence and
              Machine Learning (AI&ML). Our curriculum has been structured to
              offer students a robust foundation in Computer Science while
              immersing them in the rapidly evolving world of AI and ML
              technologies.
            </p>
          </div>
          ...
          <div className="bg-white text-gray-800 rounded-lg shadow-lg p-8 transition-all hover:scale-[1.02]">
            ...
            <p className="text-sm leading-relaxed mb-4">
              Our college intakes students either by:
              <br />
              1. Counselling through <strong>AKTU</strong>
              <br />
              or <br />
              2. Direct admission through campus (as per AKTU norms)
            </p>
            <p className="text-sm leading-relaxed mb-4">
              <strong>Course Fee:</strong>
              <br />
              For B.Tech 1st Year: ₹57,500 (approx.)
              <br />
              For B.Tech 2nd Year (Lateral Entry): ₹30,000 – ₹32,000 (with
              scholarship)
            </p>
            <button
              onClick={() => setIsModalOpen(true)}
          ...
          <div className="bg-yellow-400 text-gray-900 rounded-lg shadow-lg p-8 transition-all hover:scale-[1.02]">
            ...
            <p className="text-sm leading-relaxed mb-4">
              <strong>Our Mission:</strong> To provide high-quality education
              that empowers students to excel in AI & ML with the knowledge,
              skills, and ethical values to become proficient professionals.
            </p>
            <p className="text-sm leading-relaxed">
              <strong>Our Vision:</strong> To become a center of excellence in
              AI & ML, producing globally competent innovators, problem-solvers,
              and leaders committed to responsible technological advancement.
            </p>
          </div>
        </div>
      </section>

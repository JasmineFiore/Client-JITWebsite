...
//   ),
//   "Sports Day": ["/images/sports1.jpg", "/images/sports2.jpg"],
//   "Yoga Day": ["/images/yoga1.jpg", "/images/yoga2.jpg"],
//   "J-Tech FUSION": ["/images/jtech1.jpg", "/images/jtech2.jpg"],
//   "Heritage Visit": ["/images/heritage1.jpg", "/images/heritage2.jpg"],
// };
...
//     <>
//       {" "}
//       <section className="bg-[#0A2342] flex items-center justify-center px-6 py-3">
//         {" "}
//         <div className="max-w-7xl w-full">
//           {" "}
//           <div className="text-white md:w-1/2">
//             {" "}
//             <h1 className="text-6xl font-extrabold mb-2 text-left">
//               Events
//             </h1>{" "}
//           </div>{" "}
//         </div>{" "}
//       </section>
//       ```
//       <div className="bg-gray-100 p-6 md:px-28">
//         {/* Video Section */}
//         <div className="mb-8">
...
//               width: "100%",
//               height: "600px",
//               playerVars: { autoplay: videoPlaying ? 1 : 0 },
//             }}
//           />
//         </div>
...
//               <h3 className="text-xl font-semibold mb-4">{event}</h3>
...
//                         />
//                       </figure>
//                       <span className="absolute top-2 right-2 text-white bg-black bg-opacity-50 px-2 py-1 text-sm rounded">
...
//         >
//           <div className="relative max-w-5xl w-full px-2">
//             <img
...
//               className="absolute top-2 right-2 text-white text-2xl bg-black bg-opacity-50 px-2 py-1 rounded"
//             >
//               ✕
//             </button>
//             <div className="absolute bottom-2 right-1/2 transform translate-x-1/2 text-white text-sm bg-black bg-opacity-50 px-2 py-1 rounded">
